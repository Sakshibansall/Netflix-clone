    ...
    <header>
      <nav className=' navbar flex justify-between items-center  lg:px-30 md:px-10 sm:px-7  py-7 absolute top-0 left-0 w-full z-50'>
        ...
        <div className=' flex items-center space-x-4'>
          ...
          <select className="lang px-4 py-2 rounded border border-gray-400 cursor-pointer text-white font-semibold text-xl" id="#">
          ...
          {/* Sign up btn */}
          <button className='btn text-white bg-[#e50914] px-5 py-2 font-semibold cursor-pointer text-xl hover:bg-red-700 transition duration-400 rounded'>Sign In</button>
        </div>
      </nav>
